...
# def shows_all(requests):
#     shows = models.TVShow.objects.all()
#     return render(requests, 'shows_list.html', {'shows': shows})
...
class ShowsCreatView(generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        return super(ShowsCreatView, self).form_valid(form=form)
...
#         if form.is_valid():
#             form.save()
#             return HttpResponse('Show successfully Updated ')
#     else:
